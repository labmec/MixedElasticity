/**
 * @file
 * @brief Contains the TPZMixedSymElasticityND class which implements an N-dimensional elastic material.
 */

#ifndef MIXEDSYMELASMATNDHPP
#define MIXEDSYMELASMATNDHPP
 ...
 */
class TPZMixedSymElasticityND : public TPZMatBase<STATE, TPZMatCombinedSpacesT<STATE>,
...
public:
    ...
    enum MVoigtSym {
        ExxS, EyyS, ExyS, ExzS, EyzS, EzzS
    };

    /** @brief Default constructor */
    TPZMixedSymElasticityND();
    /** 
     ...
     */
    TPZMixedSymElasticityND(int id, REAL E, REAL nu, REAL fx, REAL fy, int planestress = 1, int Dimension = 1);

    TPZMixedSymElasticityND(int id, int dimension = 2);

    /** @brief Copies the data of one TPZMixedSymElasticityND object to another */
    TPZMixedSymElasticityND(const TPZMixedSymElasticityND &copy);
    ...
    virtual TPZMaterial * NewMaterial()  const override {
        return new TPZMixedSymElasticityND(*this);
    }

    /** @brief Default destructor */
    virtual ~TPZMixedSymElasticityND();
...
//    }
    ...
    virtual std::string Name() const override {
        return "TPZMixedSymElasticityND";
    }
    ...
    virtual void Contribute_2spaces(const TPZVec<TPZMaterialDataT<STATE>> &data, REAL weight, TPZFMatrix<STATE> &ek, TPZFMatrix<STATE> &ef);
